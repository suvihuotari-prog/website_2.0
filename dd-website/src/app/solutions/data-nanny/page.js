...
/* ──────────────────────────────────────────────
   Page
   ────────────────────────────────────────────── */
export default function DataNannyPage() {
  return (
    <>
      {/* HERO */}
      <HeroSection
        ...
        badge="DataNanny · Industrial Data Enrichment"
        frameworkBadge="Built on DD AI Labs — production-deployed at Sarlin"
        title="Cut equipment data cleanup from months to hours"
        subtitle="Incomplete device registers quietly drain margin — mispriced quotes, wrong spare parts, reactive maintenance. DataNanny enriches your equipment register automatically, so your team builds quotes, plans maintenance, and reports on data they can actually trust."
      ...
      <section style={{ background: C.gray }}>
        <div style={{ maxWidth: CONTAINER_MAX_WIDTH, margin: "0 auto", padding: SECTION_PADDING }}>
          <SectionTitle
            ...
            subtitle="DataNanny transforms raw equipment lists into rich, standardized records — enabling smarter maintenance, better procurement, and data-driven decisions."
          />
      ...
      <section style={{ background: C.white }}>
        <div style={{ maxWidth: CONTAINER_MAX_WIDTH, margin: "0 auto", padding: SECTION_PADDING }}>
          ...
          <div className="dd-compare-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            <Reveal delay={0.1}>
              <div>
                <h4 style={{ fontSize: 13, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: C.seawave, marginBottom: 16 }}>With DataNanny</h4>
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[
      ...
      <section style={{ background: C.gray }}>
        <div style={{ maxWidth: CONTAINER_MAX_WIDTH, margin: "0 auto", padding: SECTION_PADDING }}>
          <SectionTitle
            ...
            subtitle="DataNanny is built for organizations that live and die by the quality of their equipment register."
          />
          <div className="dd-challenge-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
            {[
              {
      ...
      {/* CTA */}
      <CTASection
        heading="In 30 minutes, you'll know if DataNanny fits your register"
