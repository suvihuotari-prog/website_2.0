...
const PARTNERS = [
  {
    ...
    description: "Liiketoimintalähtöinen tekoälystrategi, joka on auttanut lukuisia asiakkaita suunnittelemaan ja toteuttamaan tekoälyvisionsa.",
  ...
  },
  {
    ...
    description: "Tekoälyjohtaja 20+ vuoden kokemuksella, tunnettu 200M€+ liikevaihtovaikutuksen toimittamisesta H&M:llä.",
  ...
  },
  {
    ...
    description: "Asiantuntija datastrategioissa, hallinnassa ja yritysarkkitehtuurissa. Bilot Oyj:n perustaja.",
  ...
  },
  {
    ...
    description: "Johti aiemmin datastrategian ja tiedonhallintakäytäntöä Deloittella. Pragmaattinen tapa saada data toimimaan.",
  ...
  return (
    <>
      <HeroSection
        gradient="lemon"
        badge="Yhteystiedot"
        title="Keskustellaan mitä tekoäly voi tehdä liiketoiminnallenne"
        subtitle="Ei 40-sivuista tarjouspyyntöä. Ei myyntipakkaa. Vain suora keskustelu jonkun kanssa joka on tehnyt tämän ennen."
        ...
        <div style={{ maxWidth: CONTAINER_MAX_WIDTH, margin: "0 auto", padding: SECTION_PADDING }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 640, marginBottom: 52 }}>
              Ota yhteyttä suoraan tai varaa 30 minuutin keskustelu. Olemme rehellisiä siitä voimmeko auttaa.
            </p>
          </Reveal>
            ...
            <Reveal delay={0}>
              <a href="mailto:info@datadesign.fi" style={{ textDecoration: "none", display: "block", height: "100%" }}>
                ...
                >
                  ...
                  <h3 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8, color: C.black }}>Sähköposti</h3>
            ...
            <Reveal delay={0.1}>
              <a href="tel:+358504420008" style={{ textDecoration: "none", display: "block", height: "100%" }}>
                ...
                >
                  ...
                  <h3 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8, color: C.black }}>Puhelin</h3>
            ...
            <Reveal delay={0.2}>
              <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", display: "block", height: "100%" }}>
                ...
                >
                  ...
                  <h3 style={{ fontSize: 18, fontWeight: 600, marginBottom: 8, color: C.black }}>Varaa keskustelu</h3>
                  <p style={{ fontSize: 15, color: C.seawave, fontWeight: 500 }}>30 min, ilmainen, ei sitoumusta</p>
                </div>
              </a>
            </Reveal>
          </div>
      ...
      <section style={{ background: C.white }}>
        <div style={{ maxWidth: CONTAINER_MAX_WIDTH, margin: "0 auto", padding: SECTION_PADDING }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 640, marginBottom: 52 }}>
              Ota yhteyttä suoraan. Yhdistämme sinut oikean henkilön kanssa haasteellesi.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.3}>
            <div style={{
              ...
              <p style={{ fontSize: 14.5, color: C.textMuted, lineHeight: 1.6 }}>
                ...
                näkemyksiä, asiakastarinoita ja yritysuutisia varten.
              </p>
            </div>
          </Reveal>
        </div>
