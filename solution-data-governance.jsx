    ...
    <nav style={{
      ...
      <div style={{
        ...
        <div className="dd-nav-desktop" style={{ display: "flex", alignItems: "center", gap: 36 }}>
          {NAV_LINKS.map((l) => (
            <a key={l.href} href={l.href} style={{ color: C.black, textDecoration: "none", fontSize: 15, fontWeight: 400, transition: "opacity 0.2s" }}
              onMouseEnter={e => e.currentTarget.style.opacity = "0.5"}
              onMouseLeave={e => e.currentTarget.style.opacity = "1"}
            >{l.label}</a>
          ))}
          <a href="https://calendly.com/mika-aho-datadesign/30min" target="_blank" rel="noopener noreferrer"
            style={{ background: C.black, color: C.white, padding: "11px 28px", borderRadius: 100, fontWeight: 500, fontSize: 15, textDecoration: "none", transition: "opacity 0.2s" }}
        ...
        <button className="dd-nav-hamburger" onClick={() => setMenuOpen(!menuOpen)} style={{ display: "none", background: "none", border: "none", cursor: "pointer", padding: 8 }}>
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
            {menuOpen
              ...
              : <><line x1="3" y1="7" x2="23" y2="7" stroke={C.black} strokeWidth="2" strokeLinecap="round" /><line x1="3" y1="13" x2="23" y2="13" stroke={C.black} strokeWidth="2" strokeLinecap="round" /><line x1="3" y1="19" x2="23" y2="19" stroke={C.black} strokeWidth="2" strokeLinecap="round" /></>}
          </svg>
        </button>
      </div>
      {menuOpen && (
        <div className="dd-nav-mobile" style={{ display: "none", flexDirection: "column", gap: 16, padding: "24px 40px 32px", background: C.white, borderTop: `1px solid ${C.border}` }}>
          ...
          <a href="https://calendly.com/mika-aho-datadesign/30min" target="_blank" rel="noopener noreferrer"
            style={{ background: C.black, color: C.white, padding: "14px 28px", borderRadius: 100, fontWeight: 500, fontSize: 16, textDecoration: "none", textAlign: "center", marginTop: 8 }}
          >Book a call</a>
        </div>
      )}
    </nav>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "100px 40px 80px" }}>
          <Reveal>
            <div style={{ marginBottom: 24 }}>
              <a href="/our-services" style={{ color: C.textMuted, textDecoration: "none", fontSize: 14, transition: "opacity 0.2s" }}
                onMouseEnter={e => e.currentTarget.style.opacity = "0.6"} onMouseLeave={e => e.currentTarget.style.opacity = "1"}
              >Services</a>
              <span style={{ color: C.textMuted, fontSize: 14, margin: "0 8px" }}>/</span>
              <span style={{ color: C.black, fontSize: 14, fontWeight: 500 }}>Data Governance & Quality</span>
            </div>
          </Reveal>
          <Reveal delay={0.03}>
            <div style={{ display: "inline-flex", padding: "5px 14px", borderRadius: 100, background: "rgba(0,0,0,0.06)", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em", color: C.seawave, marginBottom: 14 }}>
          ...
          <Reveal delay={0.04}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 12px", borderRadius: 100, background: `${C.lemon}88`, fontSize: 11, fontWeight: 500, color: C.black, marginBottom: 20, marginLeft: 8 }}>
              ...
              Proven framework — deployed across 5+ organizations
            </div>
          </Reveal>
          <Reveal delay={0.06}>
          ...
          <Reveal delay={0.1}>
            <p style={{ fontSize: 18, lineHeight: 1.7, maxWidth: 620, color: C.textMuted, marginBottom: 36 }}>
              Unclear ownership, inconsistent quality, siloed systems — your data problems are blocking every AI initiative. You need practical governance models that get adopted, not just documented.
            </p>
          </Reveal>
          <Reveal delay={0.14}>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <a href="https://calendly.com/mika-aho-datadesign/30min" target="_blank" rel="noopener noreferrer"
                style={{ display: "inline-block", background: C.black, color: C.white, padding: "14px 36px", borderRadius: 100, fontWeight: 500, fontSize: 16, textDecoration: "none", transition: "opacity 0.2s" }}
                onMouseEnter={e => e.currentTarget.style.opacity = "0.85"} onMouseLeave={e => e.currentTarget.style.opacity = "1"}
              >Book a free call</a>
              <a href="/our-services"
                style={{ display: "inline-block", background: "transparent", color: C.black, padding: "14px 36px", borderRadius: 100, border: `1px solid ${C.black}`, fontWeight: 500, fontSize: 16, textDecoration: "none", transition: "all 0.2s" }}
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "88px 40px" }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 620, marginBottom: 52 }}>
              Data governance sounds boring until its absence blocks every initiative you care about.
            </p>
          </Reveal>
          <div className="dd-challenge-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
            {[
              { title: "No clear data ownership", body: "When something goes wrong with data, nobody knows who's responsible. Decisions stall because accountability is unclear." },
              { title: "Data quality that erodes trust", body: "Inconsistencies, duplicates, missing values — your people have stopped trusting the numbers. They build their own spreadsheets instead." },
              { title: "AI initiatives blocked by data problems", body: "Every AI project starts with 'first we need to fix the data.' Without governance, you're stuck in an endless loop of data preparation." },
            ].map((item, i) => (
      ...
      <section style={{ background: C.gray }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "88px 40px" }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 620, marginBottom: 52 }}>
              Governance that works means governance people actually use. Our approach is practical, not theoretical.
            </p>
          </Reveal>
          <div className="dd-steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
            {[
              { step: "1", title: "Current state assessment", desc: "We map your existing data landscape, ownership gaps, quality issues, and the business processes that depend on reliable data." },
              { step: "2", title: "Ownership & responsibility model", desc: "We define who owns what data — aligned to business processes, not IT systems. Clear roles that make sense to the people who'll carry them." },
              { step: "3", title: "Quality framework", desc: "Practical quality rules, monitoring, and improvement processes. Metrics your teams can actually follow — not a 200-page policy document." },
              { step: "4", title: "Adoption & change management", desc: "Governance only works if people use it. We design adoption plans, run training, and embed governance into existing workflows." },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 0.06}>
      ...
      <section style={{ background: C.lemon }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "88px 40px" }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 620, marginBottom: 52 }}>
              Governance models that get adopted — not just documented.
            </p>
          </Reveal>
          <div className="dd-proof-grid" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 20 }}>
            <Reveal delay={0.05}>
              <CaseCard company="Anora" tag="Beverages & Spirits"
                description="Unified governance across 5 countries post-merger. 2 data domains aligned. SAP S/4HANA transformation support."
                testimonial={{ quote: "Data Design helped us take control of our master data. Their clear approach made our data more accurate and easier to manage.", name: "Matti Nurmi", title: "CIO", company: "Anora" }}
              />
            </Reveal>
            <Reveal delay={0.1}>
              <CaseCard company="Helen" tag="Energy"
                description="Data ownership aligned to business processes. Clear accountability model adopted by the organization."
              />
            </Reveal>
            <Reveal delay={0.15}>
              <CaseCard company="Wolt" tag="Technology & Delivery"
                description="Vendor on-boarding process and risk management framework. Systematic approach to third-party data governance."
              />
            </Reveal>
            <Reveal delay={0.2}>
              <CaseCard company="Neste" tag="Energy & Chemicals"
                description="Potential to mitigate €14M in distribution obligation reporting risks through improved data governance."
              />
            </Reveal>
          </div>
          <Reveal delay={0.25}>
            <div style={{ background: C.beige, borderRadius: 12, padding: "16px 20px", marginTop: 20, borderLeft: `3px solid ${C.lemon}` }}>
              <p style={{ fontSize: 13, lineHeight: 1.6, color: C.textMuted, fontStyle: "italic" }}>
                Also: MHYP — governance model for 52 forestry associations with competition law compliance.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section style={{ background: C.white }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "88px 40px" }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 620, marginBottom: 52 }}>
              Our own tools and accelerator programs make governance faster to implement and easier to sustain.
            </p>
          </Reveal>
            ...
            <Reveal delay={0.05}>
              <div style={{ background: C.gray, borderRadius: 16, padding: "24px 22px", height: "100%" }}>
                ...
                <p style={{ fontSize: 14, lineHeight: 1.6, color: C.textMuted }}>
                  Automatically document your data assets — no manual effort. GenAI-powered solution that creates business-friendly descriptions by extracting metadata.
                </p>
              </div>
            </Reveal>
            <Reveal delay={0.1}>
              <div style={{ background: C.gray, borderRadius: 16, padding: "24px 22px", height: "100%" }}>
                ...
                <h4 style={{ fontSize: 17, fontWeight: 600, marginBottom: 8 }}>Data Governance Kickstart</h4>
                <p style={{ fontSize: 14, lineHeight: 1.6, color: C.textMuted }}>
                  5+ models deployed. A structured program to define ownership, establish quality, and create governance that enables AI — not blocks it.
                </p>
              </div>
            </Reveal>
          </div>
          <Reveal delay={0.15}>
            <div style={{ textAlign: "center", marginTop: 32 }}>
              <a href="/products-tools" style={{ color: C.seawave, fontSize: 15, fontWeight: 500, textDecoration: "none", transition: "opacity 0.2s" }}
                onMouseEnter={e => e.currentTarget.style.opacity = "0.6"} onMouseLeave={e => e.currentTarget.style.opacity = "1"}
      ...
      <section style={{ background: C.beige }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "88px 40px" }}>
          <Reveal>
            ...
            <p style={{ fontSize: 17, lineHeight: 1.6, color: C.textMuted, maxWidth: 620, marginBottom: 52 }}>
              Practical governance that unblocks your AI ambitions and improves data quality across the organization.
            </p>
          </Reveal>
          <Reveal delay={0.05}>
            <div style={{ background: C.white, borderRadius: 20, padding: "40px 36px", border: `1px solid ${C.border}` }}>
              ...
              <div style={{ borderTop: `1px solid ${C.border}`, marginTop: 28, paddingTop: 24, display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ display: "inline-flex", padding: "6px 16px", borderRadius: 100, background: C.lemon, fontSize: 13, fontWeight: 600 }}>Around 2 months</div>
                <span style={{ fontSize: 14, color: C.textMuted }}>From assessment to adopted governance model</span>
              </div>
            </div>
          </Reveal>
        </div>
          ...
          <Reveal>
            <div className="dd-cta-row" style={{ display: "flex", minHeight: 420, position: "relative", overflow: "hidden" }}>
              <div className="dd-cta-left" style={{ flex: 1, position: "relative", padding: "72px 60px", display: "flex", flexDirection: "column", justifyContent: "center", zIndex: 2 }}>
                ...
                <h2 style={{ fontSize: 44, fontWeight: 400, lineHeight: 1.15, marginBottom: 20, letterSpacing: "-0.02em", position: "relative" }}>
                  Ready to take control of your data?
                </h2>
                <p style={{ fontSize: 16, lineHeight: 1.6, color: C.textMuted, marginBottom: 32, position: "relative", maxWidth: 440 }}>
                  Book a free 30-minute call. We'll discuss your data challenges and share how other organizations have built governance that actually works.
                </p>
                <div style={{ display: "flex", gap: 12, flexWrap: "wrap", position: "relative" }}>
                  <a href="https://calendly.com/mika-aho-datadesign/30min" target="_blank" rel="noopener noreferrer"
                    style={{ display: "inline-block", background: C.white, color: C.black, padding: "14px 32px", borderRadius: 100, border: `1px solid ${C.black}`, fontWeight: 500, fontSize: 15, textDecoration: "none", transition: "all 0.2s ease" }}
                    onMouseEnter={e => { e.currentTarget.style.background = C.black; e.currentTarget.style.color = C.white; }}
              ...
              <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="280" height="240" viewBox="0 0 280 240" fill="none" style={{ opacity: 0.85 }}>
                  <g transform="translate(30, 20)">
                    <rect x="20" y="30" width="180" height="160" rx="14" fill={C.white} stroke={C.black} strokeWidth="1.2"/>
                    <rect x="40" y="55" width="60" height="10" rx="3" fill={C.turquoise}/>
                    <rect x="40" y="75" width="140" height="6" rx="3" fill={C.gray}/>
                    <rect x="40" y="90" width="140" height="6" rx="3" fill={C.gray}/>
                    <rect x="40" y="105" width="100" height="6" rx="3" fill={C.gray}/>
                    <line x1="40" y1="125" x2="180" y2="125" stroke={C.border} strokeWidth="1"/>
                    <rect x="40" y="135" width="60" height="10" rx="3" fill={C.lemon}/>
                    <rect x="40" y="155" width="140" height="6" rx="3" fill={C.gray}/>
                    <rect x="40" y="170" width="80" height="6" rx="3" fill={C.gray}/>
                    <path d="M185 45l8 8-8 8" stroke={C.seawave} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </g>
                </svg>
              </div>
            </div>
